...
import {type RecipeResponse } from "../../types/type"

const {data, error} = await useFetch<RecipeResponse>("https://dummyjson.com/recipes?limit=14")
...
<template>
    ...
    <section class="py-20 container">
      ...
      <RecepieCrad  v-for="recipe in data?.recipes" :key="recipe.id" :recipe="recipe"/>
      </div>
